    ...
    def train(G, C1, C2, config, epoch):
        ...
        for i in range(1, num_iter + 1):
            ...
            if config['mcd_vat']:
                ...
                if i == 0:
                    print('Epoch: {} Stage1, source_vat_loss1: {:.6f},  source_vat_loss2: {:.6f}, target_vat_loss1: {:.6f},  target_vat_loss2: {:.6f}'.format(
                        epoch, source_vat_loss1.item(), source_vat_loss2.item(), target_vat_loss1.item(), target_vat_loss2.item()))
            ...
            if config['mcd_entropy'] == 1:
                ...
                if i == 0:
                    print('Epoch: {} Stage1, entropy c1: {:.6f},  entropy c2: {:.6f}'.format(
                        epoch, entropy_loss_c1.item(), entropy_loss_c2.item()))
            ...
            if i == 0:
                print('Epoch: {} Stage2, Loss1: {:.6f}, Loss2: {:.6f}  Disc S: {:.6f},  Disc T: {:.6f}'.format(
            ...
            for _ in range(1):
                ...
                if i == 0:
                    print('Epoch: {} Stage3, Loss1: {:.6f}\t Loss2: {:.6f}\t  Discrepancy S: {:.6f}\t  Discrepancy T: {:.6f}'.format(
                        epoch, loss_s1.item(), loss_s2.item(), loss_dis_s.item(), loss_dis_t.item()))
