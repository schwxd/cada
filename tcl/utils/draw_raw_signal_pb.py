...
def read_dir_all(dirpath):
    ...
    drawlist = ['N15_M01_F10_K001_1.mat', 'N15_M07_F04_K001_1.mat', 'N15_M07_F10_K001_1.mat', 
                'N15_M01_F10_KA04_1.mat', 'N15_M07_F04_KA04_1.mat', 'N15_M07_F10_KA04_1.mat',
                'N15_M01_F10_KI04_1.mat', 'N15_M07_F04_KI04_1.mat', 'N15_M07_F04_KI04_1.mat']
    img_index = ['a', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i']
    plt.figure(figsize=(15, 10))
    DATALEN = 4000
    index = np.arange(0, DATALEN, 1)
    count = 1
    ...
    for filepath, load, label in zip(filepaths, loads_list, labels_list):
        ...
        feature_tensor = load_matfile(os.path.join(dirpath, filepath))

        if filepath in drawlist:
            print('key {}, count {}, total length {}'.format(filepath, count, len(drawlist)))
            plt.subplot(len(drawlist), 1, count)
            plt.plot(index, feature_tensor[:DATALEN])
            # plt.ylim([-1, 1])
            plt.xlabel('Time (ms)')
...
if __name__ == '__main__':
    ...
    print(args)
    data_dir = "D:/fault/cdan-snr-1124-commit/matdata/pb-matdata"
