...
class Inception_Single(nn.Module):
    ...
    def __init__(self, inf, c1, c2, c3, c4):
        super(Inception_Single, self).__init__()
        self.branch1 = BasicConv1d(inf, c1, kernel_size=1, stride=1, dilation=2)

        self.branch2 = nn.Sequential(
            BasicConv1d(inf, CM, kernel_size=1, stride=1, dilation=1),
            BasicConv1d(CM, c2, kernel_size=5, stride=1, padding=2, dilation=1)
        )

        self.branch3 = nn.Sequential(
            BasicConv1d(inf, CM, kernel_size=1, stride=1, dilation=1),
            BasicConv1d(CM, c3, kernel_size=7, stride=1, padding=3, dilation=1)
        )

        self.branch4 = nn.Sequential(
            nn.AvgPool1d(3, stride=1, padding=1, count_include_pad=False),
            BasicConv1d(inf, c4, kernel_size=1, stride=1, dilation=1)
        )
...
class InceptionV1(nn.Module):
    ...
    def __init__(self, num_classes=5):
        ...
        self.features = nn.Sequential(
            ...
            Inception_Single(inf=128, c1=64, c2=64, c3=32, c4=32),  # Inception*2
            Inception_Single(inf=192, c1=64, c2=64, c3=32, c4=32),  
            nn.MaxPool1d(3, stride=3),

            Inception_Single(inf=192, c1=64, c2=64, c3=32, c4=32),  # Inception*2
            Inception_Single(inf=192, c1=64, c2=64, c3=32, c4=32),  
            Inception_Single(inf=192, c1=48, c2=48, c3=32, c4=32),  # Inception*3
            Inception_Single(inf=160, c1=48, c2=48, c3=32, c4=32),
            Inception_Single(inf=160, c1=48, c2=48, c3=32, c4=32),
            nn.MaxPool1d(3, stride=3),


            Inception_Single(inf=160, c1=64, c2=96, c3=64, c4=32), # Inception*3
            Inception_Single(inf=256, c1=64, c2=96, c3=64, c4=32),
            Inception_Single(inf=256, c1=64, c2=96, c3=64, c4=32),
            nn.MaxPool1d(3, stride=3),

            Inception_Single(inf=256, c1=128, c2=128, c3=256, c4=96),  # Inception*2
            nn.MaxPool1d(2, stride=2),

            Inception_Single(inf=608, c1=96, c2=96, c3=128, c4=64), # Inception5a
            Inception_Single(inf=384, c1=96, c2=96, c3=128, c4=64), # Inception5b
